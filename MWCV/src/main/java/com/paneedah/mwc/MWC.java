...
public final class MWC {
	...
	public static final CreativeTabs THROWABLES_TAB = null;
    ...
    public void preInit(FMLPreInitializationEvent preInitializationEvent) {
        ...
        com.paneedah.weaponlib.stats.AttachmentStatsManager.init(new java.io.File(preInitializationEvent.getModConfigurationDirectory(), "mwccf"));
    ...
    public void init(FMLInitializationEvent initializationEvent) {
        ...
        CHANNEL.registerMessage(new AmmoPackCombineMessageHandler(), AmmoPackCombineMessage.class, 15, Side.SERVER);
    }
