...
public class MWCItems {
    ...
    public static com.paneedah.mwc.items.equipment.ItemAmmoPack ammoPack;
    ...
    public static void init() {
        ...
        ammoPack = new com.paneedah.mwc.items.equipment.ItemAmmoPack();
    }
    ...
    public static void registerItems(RegistryEvent.Register<Item> itemRegistryEvent) {
        ...
        itemRegistryEvent.getRegistry().register(ammoPack);
    ...
    public static void registerRenders(ModelRegistryEvent modelRegistryEvent) {
        ...
        ModelLoader.setCustomModelResourceLocation(ammoPack, 0, new ModelResourceLocation(ammoPack.getRegistryName(), "inventory"));
    }
