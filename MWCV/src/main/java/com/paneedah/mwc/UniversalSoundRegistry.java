...
public class UniversalSoundRegistry {
	...
	public static void init() {
		...
		UniversalSoundLookup.registerSoundToLookup("pistol_draw");
		UniversalSoundLookup.registerSoundToLookup("other_draw");
		...
		UniversalSoundLookup.registerSoundToLookup("ammobox");
	}
}
