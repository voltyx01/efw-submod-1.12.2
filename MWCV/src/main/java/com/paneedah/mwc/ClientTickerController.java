...
public final class ClientTickerController {
    ...
    private static final class ClientTicker {
        ...
        private static void onRightMouseButtonReleased() {
            ...
            if (mainHandHeldWeaponInstance != null && item instanceof Weapon) {
                if (ModernConfigManager.holdToAim && mainHandHeldWeaponInstance.isAimed()) {
                    ...
                    ((Weapon) item).toggleAiming();
                } else if (mainHandHeldWeaponInstance.isAimed()) {
                    // Toggle mode: if RMB released while aimed during reload, un-aim
                    com.paneedah.weaponlib.WeaponState ws = mainHandHeldWeaponInstance.getState();
                    boolean isDuringReload = ws == com.paneedah.weaponlib.WeaponState.LOAD
                            || ws == com.paneedah.weaponlib.WeaponState.LOAD_REQUESTED
                            || ws == com.paneedah.weaponlib.WeaponState.LOAD_ITERATION
                            || ws == com.paneedah.weaponlib.WeaponState.LOAD_ITERATION_COMPLETED
                            || ws == com.paneedah.weaponlib.WeaponState.ALL_LOAD_ITERATIONS_COMPLETED
                            || ws == com.paneedah.weaponlib.WeaponState.AWAIT_FURTHER_LOAD_INSTRUCTIONS
                            || ws == com.paneedah.weaponlib.WeaponState.UNLOAD
                            || ws == com.paneedah.weaponlib.WeaponState.UNLOAD_REQUESTED
                            || ws == com.paneedah.weaponlib.WeaponState.UNLOAD_PREPARING
                            || ws == com.paneedah.weaponlib.WeaponState.TACTICAL_RELOAD
                            || ws == com.paneedah.weaponlib.WeaponState.COMPOUND_RELOAD
                            || ws == com.paneedah.weaponlib.WeaponState.COMPOUND_RELOAD_EMPTY
                            || ws == com.paneedah.weaponlib.WeaponState.COMPOUND_RELOAD_UNLOAD
                            || ws == com.paneedah.weaponlib.WeaponState.COMPOUND_RELOAD_FINISH
                            || ws == com.paneedah.weaponlib.WeaponState.COMPOUND_REQUESTED
                            || ws == com.paneedah.weaponlib.WeaponState.COMPOUND_EMTPY_REQUESTED;
                    if (isDuringReload) {
