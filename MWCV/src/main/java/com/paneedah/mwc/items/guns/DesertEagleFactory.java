    ...
    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withActionPiece(Attachments.DesertEagleSlide, Attachments.DesertEagleSlideGolden,
                        ...
                        // Register the same keyframed action animations (load/unload/load-empty/
                        // unload-empty/etc.) for the Golden and Black slide variants. Without this,
                        // these attachments fall back to addFallbackIfNeeded()'s static per-frame
                        // positioning, which has no interpolation between keyframes and causes the
                        // slide to instantly snap open/closed instead of animating smoothly.
                        ...
                        .withFirstPersonPositioningCustomRecoiled(Attachments.DesertEagleSlide.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                })
                        .withFirstPersonPositioningCustomZoomingRecoiled(
                                Attachments.DesertEagleSlide.getRenderablePart(), (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                })
                        .withFirstPersonCustomPositioning(Attachments.DesertEagleSlide.getRenderablePart(),
                                (renderContext) -> {
                        ...
                        .withFirstPersonPositioningCustomRecoiled(
                                Attachments.DesertEagleSlideGolden.getRenderablePart(), (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                })
                        .withFirstPersonPositioningCustomZoomingRecoiled(
                                Attachments.DesertEagleSlideGolden.getRenderablePart(), (renderContext) -> {
                        ...
                        .withFirstPersonCustomPositioning(Attachments.DesertEagleSlideGolden.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                                })
                        .withFirstPersonPositioningCustomRecoiled(Attachments.DesertEagleSlideBlack.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                })
                        .withFirstPersonPositioningCustomZoomingRecoiled(
                                Attachments.DesertEagleSlideBlack.getRenderablePart(), (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                })
                        .withFirstPersonCustomPositioning(Attachments.DesertEagleSlideBlack.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
