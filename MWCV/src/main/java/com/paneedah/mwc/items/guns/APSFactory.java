    ...
    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
                ...
                .withScreenShaking(RenderableState.SHOOTING,
                        ...
                        0.1f, // y
                        1f) // z
                .withModernRecipe(new CraftingEntry(MWCItems.carbonComposite, 1),
                        new CraftingEntry(MWCItems.gunmetalPlate, 4), new CraftingEntry(MWCItems.steelIngot, 3))
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonCustomPositioning(AuxiliaryAttachments.APSslide.getRenderablePart(),
                                (renderContext) -> {
