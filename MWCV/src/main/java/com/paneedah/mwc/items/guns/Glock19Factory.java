...
public class Glock19Factory implements GunFactory {
    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
                ...
                .withModernRecipe(new CraftingEntry(MWCItems.carbonComposite, 7),
                        new CraftingEntry(MWCItems.gunmetalPlate, 3), new CraftingEntry(MWCItems.steelIngot, 3))
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioning(
                                new Transform()
                                        .withPosition(-0.945000f, 3.565000f, -7.845000f)
                                        .withRotation(0.000000f, 1.000000f, 10.681469f)
                                        .withRotationPoint(-0.12000000357627871, -0.36000001072883614,
                                                0.040000001192092904)
                                        .withScale(3.0, 3.0, 3.0))
                        .withFirstPersonHandPositioning(
                                // Left hand
                                new Transform()
                                        .withPosition(1.370000f, 0.840000f, 2.020000f)
                                        .withBBRotation(-12.9672, -29.0825, 67.8433)
                                        .withScale(3, 3, 4)
                                        .withRotationPoint(0, 0, 0),
                                // Right hand
                                new Transform()
                                        .withPosition(-0.320000f, 0.115000f, 2.040000f)
                        ...
                        .withFirstPersonPositioningCustomRecoiled(Attachments.Glock19Slide.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        .withFirstPersonPositioningCustomZoomingRecoiled(Attachments.Glock19Slide.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        .withFirstPersonCustomPositioning(Attachments.Glock19Slide.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                                })
                        .withFirstPersonPositioningCustomRecoiled(Attachments.Glock19XSlide.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        .withFirstPersonPositioningCustomZoomingRecoiled(Attachments.Glock19XSlide.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        .withFirstPersonCustomPositioning(Attachments.Glock19XSlide.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                                })
                        .withFirstPersonPositioningCustomRecoiled(Attachments.Glock19RazorbackSlide.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                        ...
                        .withFirstPersonPositioningCustomZoomingRecoiled(
                                Attachments.Glock19RazorbackSlide.getRenderablePart(), (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        .withFirstPersonCustomPositioning(Attachments.Glock19RazorbackSlide.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                                })
                        .withFirstPersonPositioningCustomRecoiled(Attachments.Glock19RockSlideOlive.getRenderablePart(),
                                (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                        ...
                        .withFirstPersonPositioningCustomZoomingRecoiled(
                                Attachments.Glock19RockSlideOlive.getRenderablePart(), (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        .withFirstPersonCustomPositioning(Attachments.Glock19RockSlideOlive.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                        ...
                        .withFirstPersonPositioningCustomRecoiled(
                                Attachments.Glock19GhostPrecisionSlide.getRenderablePart(), (renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.555F);
                                    // GL11.glRotatef(45F, 0f, 1f, 0f);
                                    // GL11.glScaled(0.55F, 0.55F, 0.55F);
                                })
                        ...
                        .withFirstPersonCustomPositioning(Attachments.Glock19GhostPrecisionSlide.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                        ...
                        .withThirdPersonCustomPositioningReloading(Attachments.Glock19Slide.getRenderablePart(),
                                ...
                                }, 200, 0), // исходная позиция
                                new Transition((renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                }, 100, 50), // затвор назад — быстро
                                new Transition((renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                }, 200, 0), // держим назад пока вставляется магазин
                                new Transition((renderContext) -> {
                                    GL11.glTranslatef(0F, 0F, 0.6F);
                                }, 200, 0),
                                new Transition((renderContext) -> {
