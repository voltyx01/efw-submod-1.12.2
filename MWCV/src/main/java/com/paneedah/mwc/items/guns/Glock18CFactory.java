    ...
    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonCustomPositioning(Attachments.Glock18CSlide.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
                                })
                        .withFirstPersonCustomPositioning(Attachments.Glock18CCNCSlide.getRenderablePart(),
                                (renderContext) -> {
                                    if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                        GL11.glTranslatef(0F, 0F, 0.555F);
                                    }
