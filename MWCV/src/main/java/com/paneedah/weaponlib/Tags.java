...
public final class Tags {
    ...
    public static boolean hasLaserColor(net.minecraft.item.ItemStack itemStack) {
        return itemStack != null && itemStack.getTagCompound() != null && itemStack.getTagCompound().hasKey("LaserColor");
    }

    public static int getLaserColor(net.minecraft.item.ItemStack itemStack) {
        if (itemStack == null || itemStack.getTagCompound() == null) return 0;
        return itemStack.getTagCompound().getInteger("LaserColor");
    }

    public static void setLaserColor(net.minecraft.item.ItemStack itemStack, int color) {
        if (itemStack == null) return;
        if (itemStack.getTagCompound() == null) {
            itemStack.setTagCompound(new net.minecraft.nbt.NBTTagCompound());
        }
        itemStack.getTagCompound().setInteger("LaserColor", color);
    }
}
