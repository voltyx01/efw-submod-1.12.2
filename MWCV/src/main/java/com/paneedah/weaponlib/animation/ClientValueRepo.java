...
public class ClientValueRepo {
	...
	public static LerpedValue slidePumpValueThirdPerson = new LerpedValue();
	...
	public static double recoilWoundX;
	...
	public static void fireWeapon(PlayerWeaponInstance pwi) {
		...
		double power = params.getWeaponPower() * effStats.visualRecoilMultiplier;
