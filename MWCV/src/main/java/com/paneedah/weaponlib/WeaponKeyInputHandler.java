...
public class WeaponKeyInputHandler {
    ...
    public final void onKeyInput(InputEvent.KeyInputEvent event) {
        ...
        if (Keyboard.getEventKeyState() && eventKey != 0) {
            ...
            if (eventKey == Keyboard.KEY_F8 || (isCtrl && eventKey == Keyboard.KEY_P)) {
                com.paneedah.weaponlib.render.shells.ShellPositionManager.isAdjusterOpen = !com.paneedah.weaponlib.render.shells.ShellPositionManager.isAdjusterOpen;
                if (com.paneedah.weaponlib.render.shells.ShellPositionManager.isAdjusterOpen) {
                    player.sendMessage(new net.minecraft.util.text.TextComponentString(net.minecraft.util.text.TextFormatting.GOLD + "[MWC ShellPos] " + net.minecraft.util.text.TextFormatting.GREEN + "Настройщик позиций гильз ВКЛЮЧЕН!"));
                    player.sendMessage(new net.minecraft.util.text.TextComponentString(net.minecraft.util.text.TextFormatting.YELLOW + "Управление: " + net.minecraft.util.text.TextFormatting.WHITE + "[Стрелки] X/Y, [PgUp/PgDn или [/]] Z, [TAB] Режим, [R] Категория, [Enter] Сохранить"));
                } else {
                    player.sendMessage(new net.minecraft.util.text.TextComponentString(net.minecraft.util.text.TextFormatting.GOLD + "[MWC ShellPos] " + net.minecraft.util.text.TextFormatting.RED + "Настройщик позиций гильз ВЫКЛЮЧЕН."));
                }
                return;
            }

            if (com.paneedah.weaponlib.render.shells.ShellPositionManager.handleKeyPress(eventKey, isShift, isCtrl)) {
                return;
            }
        }
...
//        }
	    ...
	    if(!AnimationGUI.getInstance().magEdit.isState()) {
         ...
         if(KeyBindings.reloadKey.isPressed()) {
            ...
            */
            ...
            PlayerWeaponInstance instance = modContext.getPlayerItemInstanceRegistry().getMainHandItemInstance(player, PlayerWeaponInstance.class);
            if(instance != null && (instance.getState() == WeaponState.READY || instance.getState() == WeaponState.MODIFYING || instance.getState() == WeaponState.DRAWING)) {
        ...
        /*
         ...
         /*
            ...
            PlayerWeaponInstance instance = modContext.getPlayerItemInstanceRegistry().getMainHandItemInstance(player, PlayerWeaponInstance.class);
            if(instance != null && (instance.getState() == WeaponState.READY || instance.getState() == WeaponState.DRAWING)) {
            ...
            PlayerWeaponInstance instance = modContext.getPlayerItemInstanceRegistry().getMainHandItemInstance(player, PlayerWeaponInstance.class);
            if(instance != null && (instance.getState() == WeaponState.READY || instance.getState() == WeaponState.EJECT_REQUIRED || instance.getState() == WeaponState.DRAWING)) {
