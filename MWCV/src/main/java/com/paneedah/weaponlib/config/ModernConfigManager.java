...
public class ModernConfigManager {
	...
	public static final String CATEGORY_GUNPLAY = "gunplay";

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Global multiplier for weapon recoil on the Y axis (pitch)")
	public static double globalRecoilMultiplierY = 1.0;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Global multiplier for weapon recoil on the X axis (yaw)")
	public static double globalRecoilMultiplierX = 1.0;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Global multiplier for weapon spread (inaccuracy) when hip-firing")
	public static double globalSpreadMultiplierHip = 1.0;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Global multiplier for weapon spread (inaccuracy) when aiming")
	public static double globalSpreadMultiplierAim = 1.0;

	@RangeInt(min=0, max=5000)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Milliseconds to cut off from the end of the unequipping animation")
	public static int unequipAnimationCutoffMs = 0;

	@RangeDouble(min=0.1, max=10.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Multiplier for the speed of drawing a weapon (e.g. 1.5 = 50% faster)")
	public static double drawSpeedMultiplier = 1.0;

	@RangeDouble(min=0.1, max=10.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Multiplier for the speed of unequipping a weapon (e.g. 1.5 = 50% faster)")
	public static double unequipSpeedMultiplier = 1.0;

	@RangeDouble(min=0.1, max=10.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Global multiplier for reload animation speed (e.g. 1.3 = 30% faster)")
	public static double reloadSpeedMultiplier = 1.3;

	@RangeInt(min=0, max=5000)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Milliseconds to cut off from the beginning of the drawing animation")
	public static int drawAnimationCutoffMs = 0;

	@RangeInt(min=-5000, max=5000)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Milliseconds to delay the draw sound after switching weapons (can be negative to play earlier)")
	public static int drawSoundDelay = -100;

	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "If true, the camera will drop downwards (directional sway) instead of shaking (trauma sway) during draw/unequip")
	public static boolean useDirectionalCameraSway = false;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Camera sway force (trauma) when drawing a weapon")
	public static double drawCameraSwayTrauma = 2.0;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Camera sway speed (frequency) when drawing a weapon")
	public static double drawCameraSwayFrequency = 2.0;

	@RangeDouble(min=0.0, max=5.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Camera sway smoothness (length in seconds) when drawing a weapon")
	public static double drawCameraSwayLength = 0.6;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Camera sway force (trauma) when unequipping a weapon")
	public static double unequipCameraSwayTrauma = 2.0;

	@RangeDouble(min=0.0, max=100.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Camera sway speed (frequency) when unequipping a weapon")
	public static double unequipCameraSwayFrequency = 2.0;

	@RangeDouble(min=0.0, max=5.0)
	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "Camera sway smoothness (length in seconds) when unequipping a weapon")
	public static double unequipCameraSwayLength = 0.5;

	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "How much to translate pistols downwards during the unequip animation")
	public static double unequipPistolLowerAmount = 0.5;

	@ConfigSync(category = CATEGORY_GUNPLAY, comment = "The curve exponent for pistol unequipping downward movement. >1 means it accelerates.")
	public static double unequipPistolLowerSpeed = 2.0;
	...
	@ConfigSync(category = CATEGORY_RENDERING, comment = "Enables scope vignette")
	public static boolean enableScopeVignette = true;
	
	@ConfigSync(category = CATEGORY_RENDERING, comment = "Enables bullet hole decals on hit blocks")
	public static boolean enableBulletHoles = true;
