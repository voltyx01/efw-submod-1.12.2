...
public class ModificationGUI {
	...
	private static final ModificationTab MAGAZINE_TAB = new ModificationTab(11, "Magazine", AttachmentCategory.MAGAZINE, 0, 100, ModificationGroup.ATTACHMENT);
	...
	public void render(ModContext modContext) {
		// Completely disabled in favor of new GuiWeaponModding
	}
