...
public class Config
{
	...
	public static class ClientConfig
	{
		...
		public void sync()
		{
			...
			this.replaceDefaultPerspective = new BooleanValue(this.config.get(Configuration.CATEGORY_GENERAL, "Replace default perspective", true, "Whether or not to replace the default third person perspective."));
