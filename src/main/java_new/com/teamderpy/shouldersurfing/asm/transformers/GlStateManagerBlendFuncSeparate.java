...
public class GlStateManagerBlendFuncSeparate implements IShoulderMethodTransformer
{
	...
	public void transform(Mappings mappings, boolean obf, MethodNode method, int offset)
	{
		...
		method.instructions.insertBefore(first, new MethodInsnNode(INVOKESTATIC, "net/minecraft/client/renderer/GlStateManagerDelegator", "GlStateManager_tryBlendFuncSeparate", "(IIII" + blendDesc + ")Z", false));
