...
public class WorldGenTGStructureSpawn implements IWorldGenerator {
	...
	private void generateNether(World world, Random random, int cx, int cz, Biome biome) {
		...
		int SPAWNWEIGHT_SMALL = efw.biomeinfo.MwccfConfig.techguns.structures.spawnWeightSmall;
		int SPAWNWEIGHT_BIG = efw.biomeinfo.MwccfConfig.techguns.structures.spawnWeightBig;
		int SPAWNWEIGHT_MEDIUM = efw.biomeinfo.MwccfConfig.techguns.structures.spawnWeightMedium;
