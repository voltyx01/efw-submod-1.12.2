...
public class AircraftCarrier extends WorldgenStructure {
	...
	private static final ResourceLocation LOOT_TABLE = new ResourceLocation("minecraft","chests/simple_dungeon");
	...
	static {
		...
		blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE,6,2,150,2));
		blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.SOLDIER_SPAWN,1,1,200,0));
