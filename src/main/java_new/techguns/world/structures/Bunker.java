...
public class Bunker extends WorldgenStructure {
	...
	private static final ResourceLocation CHEST_LOOT = new ResourceLocation("mwccf","chests/militarybase_bunker");
	 ...
	 MBlock wallBlock = new MBlock(TGBlocks.CONCRETE, 0);//new MBlock(TGBlocks.CONCRETE, 0);
