...
public class GasStation extends WorldgenStructure {
	...
	private static final ResourceLocation CHEST_LOOT = new ResourceLocation("minecraft","chests/simple_dungeon");
	
	static ArrayList<MBlock> blockList = new ArrayList<MBlock>();
	static short[][] blocks;
	static {
		// Используйте ссылку на объект из класса TGBlocks
		blockList.add(new MBlock(TGBlocks.CONCRETE, 3));
		...
		blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE,3,2,200,1));
