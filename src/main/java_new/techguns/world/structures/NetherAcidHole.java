...
public class NetherAcidHole extends WorldgenStructure {
	...
	static {
		...
		blockList.add(new MultiMBlock(new Block[]{net.minecraft.init.Blocks.LAVA,Blocks.NETHERRACK},new int[]{0,0}, new int[]{1,1}));
		blockList.add(new MBlock(net.minecraft.init.Blocks.LAVA, 0));
