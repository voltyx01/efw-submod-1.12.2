...
public class DesertOilCluster extends WorldgenStructure {	
	...
	static {
		...
		if(net.minecraft.init.Blocks.WATER!=null) {
			MBlock oil = new MBlock(net.minecraft.init.Blocks.WATER.getDefaultState());
			ores = new MBlock[] {oil};
			oilblock = oil;
		...
		blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.SOLDIER_SPAWN,3,1,200,1));
