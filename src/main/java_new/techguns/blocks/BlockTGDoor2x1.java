...
public class BlockTGDoor2x1 extends BlockDoor implements IGenericBlock {
	...
	net.minecraft.item.Item placer;
	
	public BlockTGDoor2x1(String name, net.minecraft.item.Item placer) {
		super(Material.IRON);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.playSound(pos.getX(), pos.getY(), pos.getZ(), techguns.TGSounds.BUNKER_DOOR_OPEN, SoundCategory.BLOCKS, 1.0f, 1.0f, false);
            return true;
        }
