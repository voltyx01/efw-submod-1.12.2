...
public class BlockTGDoor3x3<T extends Enum<T> & IStringSerializable> extends GenericBlock {
    ...
    public void registerBlock(Register<Block> event) {
		...
		GameRegistry.registerTileEntity(Door3x3TileEntity.class, new ResourceLocation("mwccf","door3x3tileent"));
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		if(tile!=null && tile instanceof Door3x3TileEntity) {
			...
			return state.withProperty(TYPE, EnumDoorType.values()[0]);
		}
	...
	protected SoundEvent getClosingSound() {
		return techguns.TGSounds.TECHDOOR_CLOSE;
	}

	protected SoundEvent getOpeningSound() {
		return techguns.TGSounds.TECHDOOR_OPEN;
	}

	protected SoundEvent getStateFinishedSound() {
		return techguns.TGSounds.TECHDOOR_STATE_FINISHED;
	}
		...
		if(sound!=null) {
		 ...
		 if(tile!=null && tile instanceof Door3x3TileEntity) {
			 ...
			 if(!w.isRemote) {
				...
				} else if(false && nextState==EnumDoorState.OPENED) {
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos,
		...
		if(tile!=null && tile instanceof Door3x3TileEntity) {
			Door3x3TileEntity door = (Door3x3TileEntity) tile;
			return new ItemStack(this.placer,1,0);
		}
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		...
		if(tile!=null && tile instanceof Door3x3TileEntity) {
			Door3x3TileEntity door = (Door3x3TileEntity) tile;
			drop = new ItemStack(this.placer,1,0);
		}
	...
	protected boolean checkOpenForNearPlayers(World w, TileEntity door, BlockPos masterPos) {
		return false;
	}
