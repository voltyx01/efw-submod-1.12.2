...
public class MBlockCamoNetTop extends MBlock {
	...
	protected static IBlockState DESERT = TGBlocks.CAMONET_TOP.getDefaultState().withProperty(((techguns.blocks.BlockTGCamoNetTop)TGBlocks.CAMONET_TOP).TYPE, techguns.blocks.EnumCamoNetType.DESERT);
	protected static IBlockState SNOW = TGBlocks.CAMONET_TOP.getDefaultState().withProperty(((techguns.blocks.BlockTGCamoNetTop)TGBlocks.CAMONET_TOP).TYPE, techguns.blocks.EnumCamoNetType.SNOW);
