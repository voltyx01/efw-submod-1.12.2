...
public class ItemTGDoor2x1 extends Item {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
        ...
        if (facing != EnumFacing.UP) {
            ...
            net.minecraft.block.state.IBlockState iblockstate = worldIn.getBlockState(pos);
    ...
    public static void placeDoor(World worldIn, BlockPos pos, EnumFacing facing, Block door, boolean isRightHinge) {
        ...
        net.minecraft.block.state.IBlockState iblockstate = door.getDefaultState()
