...
public class CampProps extends WorldgenStructure {
	...
	private void setRoofBlocks(World world, int posX, int posY, int posZ,
		...
		BlockUtils.fillBlocks(world, p.setPos(posX, posY+sizeY-1, posZ), sizeX, 1, sizeZ, TGBlocks.CAMONET_TOP.getDefaultState().withProperty(((techguns.blocks.BlockTGCamoNetTop)TGBlocks.CAMONET_TOP).TYPE, camo));
	}
