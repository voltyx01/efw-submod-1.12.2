...
public class SmallMine extends WorldgenStructure {
	...
	static MBlock[] ores = {new MBlock(Blocks.COAL_ORE,0),
			new MultiMBlock(new Block[] {Blocks.IRON_ORE, Blocks.IRON_ORE, Blocks.IRON_ORE}, new int[] {0,0, 0}, new int[] {1,1,1}),
			new MultiMBlock(new Block[] {Blocks.REDSTONE_ORE, Blocks.LAPIS_ORE}, new int[] {0,0}, new int[] {1,1}),
			new MBlock(Blocks.IRON_ORE, 0),
			new MultiMBlock(new Block[] {Blocks.GOLD_ORE, Blocks.IRON_ORE}, new int[] {0,0}, new int[] {1,1}),
			new MultiMBlock(new Block[] {Blocks.DIAMOND_ORE, Blocks.EMERALD_ORE, Blocks.STONE}, new int[] {0,0,0}, new int[] {2,1,3}),
			new MultiMBlock(new Block[] {Blocks.IRON_ORE, Blocks.STONE}, new int[] {0,0}, new int[] {1,1}),
	};
	...
	static {
		...
		blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE,2,1,200,1));
