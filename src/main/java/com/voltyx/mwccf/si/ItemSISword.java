...
public class ItemSISword extends ItemSword {
    ...
    public ItemSISword(String name, ToolMaterial material, int maxDamage, float attackDamage, float attackSpeed, 
                       int bleedingTicks, boolean isElectric, SoundEvent hitSound, Supplier<Item> repairItemSupplier) {
        super(material);
