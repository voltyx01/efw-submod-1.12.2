...
public class ClientProxyMwccfMod implements IProxyMwccfMod {
	...
	public void init(FMLInitializationEvent event) {
		...
		net.minecraftforge.fml.client.registry.ClientRegistry.registerKeyBinding(KeyHandler.KEYBIND_TOGGLE_SHOULDER_SURFING);
	...
	public static void registerBlinkingLayer() {
		java.util.Map<String, net.minecraft.client.renderer.entity.RenderPlayer> skinMap = Minecraft.getMinecraft().getRenderManager().getSkinMap();

		// Добавляем к толстому скину (Стив)
		net.minecraft.client.renderer.entity.RenderPlayer defaultRender = skinMap.get("default");
		if (defaultRender != null) {
			defaultRender.addLayer(new com.voltyx.mwccf.sins.client.render.LayerBlinkingEyes(defaultRender));
		}

		// Добавляем к тонкому скину (Алекс)
		net.minecraft.client.renderer.entity.RenderPlayer slimRender = skinMap.get("slim");
		if (slimRender != null) {
			slimRender.addLayer(new com.voltyx.mwccf.sins.client.render.LayerBlinkingEyes(slimRender));
		}
	}

	public static void loadAllFromFolder(net.minecraft.client.resources.IResourceManager rm, String domain, String folderPath) {
		String[] files = {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(com.voltyx.mwccf.furniture.EntitySeat.class, manager -> {
			return new net.minecraft.client.renderer.entity.Render<com.voltyx.mwccf.furniture.EntitySeat>(manager) {
				@Override
				protected net.minecraft.util.ResourceLocation getEntityTexture(com.voltyx.mwccf.furniture.EntitySeat entity) {
					return null;
				}
				@Override
				public void doRender(com.voltyx.mwccf.furniture.EntitySeat entity, double x, double y, double z, float entityYaw, float partialTicks) {
				}
			};
		});
		net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(com.voltyx.mwccf.geo.EntityHeadlampLight.class, manager -> {
			return new net.minecraft.client.renderer.entity.Render<com.voltyx.mwccf.geo.EntityHeadlampLight>(manager) {
				@Override
				protected net.minecraft.util.ResourceLocation getEntityTexture(com.voltyx.mwccf.geo.EntityHeadlampLight entity) {
					return null;
				}
				@Override
				public void doRender(com.voltyx.mwccf.geo.EntityHeadlampLight entity, double x, double y, double z, float entityYaw, float partialTicks) {
