...
public class InspectDustManager {
    ...
    public void updateAndRender(int width, int height, Minecraft mc) {
        ...
        // Явно восстанавливаем depthMask/depth test — не полагаемся только на
        // glPopAttrib, т.к. GlStateManager кеширует состояние отдельно и может
        // не заметить "сырое" восстановление, из-за чего у следующей отрисованной
        // геометрии (например, 3D-модели игрока в этом же кадре) ломается
        // взаимное перекрытие полигонов.
